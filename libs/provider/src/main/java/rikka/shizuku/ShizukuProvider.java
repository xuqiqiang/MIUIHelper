...
public class ShizukuProvider extends ContentProvider {
    ...
    private static final String EXTRA_BINDER = "com.xuqiqiang.fuckmiui.intent.extra.BINDER";

    public static final String PERMISSION = "moe.shizuku.manager.permission.API_V23";

    public static final String MANAGER_APPLICATION_ID = "com.xuqiqiang.fuckmiui";
