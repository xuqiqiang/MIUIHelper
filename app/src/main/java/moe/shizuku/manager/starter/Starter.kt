...
import com.xuqiqiang.fuckmiui.utils.IOUtils
...
object Starter {
    ...
    private fun copyStarter(context: Context, out: File): String {
        ...
        while (entries.hasMoreElements()) {
            ...
            dis.readFully(buf)
            IOUtils.copy(ByteArrayInputStream(buf), fos)
            break
        }
